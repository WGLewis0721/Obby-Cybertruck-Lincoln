...
- Language: Luau (Roblox's Lua 5.1 superset). Always use --!strict at the top of scripts.
	...
	- ModuleScripts live in: ReplicatedStorage/Modules (shared logic) or 
		ServerScriptService/Modules (server-only logic)
	- RemoteEvents and RemoteFunctions live in: ReplicatedStorage/RemoteEvents
