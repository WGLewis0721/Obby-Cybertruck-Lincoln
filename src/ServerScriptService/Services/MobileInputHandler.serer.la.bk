--[[
    ...
    Events Listened:
        - Remotes.MobileThrottle (C→S, value: 1 = throttle on, 0 = off)
--]]
...
local mobileThrottle = remotesFolder:WaitForChild("MobileThrottle")

-- ── Helpers ───────────────────────────────────────────────────────────────────

local function getDriveSeat(player)
...
local function isPlayerInSeat(player, seat)
