...
processRaceCoins.OnInvoke = function(player, mapId, isNewBest)
	...
	PlayerDataInterface.UpdateData(userId, function(data)
		...
		earned = isFirst and EconomyConfig.FIRST_COMPLETION_REWARD or EconomyConfig.REPEAT_COMPLETION_REWARD
		if isNewBest == true then
			earned += EconomyConfig.PERSONAL_BEST_BONUS
		end
