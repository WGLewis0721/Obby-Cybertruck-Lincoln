...
-- Ensure Remotes folder + SelectMap RemoteEvent exist.
local remotesFolder = ReplicatedStorage:WaitForChild("Remotes", 10)
if not remotesFolder then
	warn("MapSelector: Remotes folder not found in ReplicatedStorage")
	return
end
...
if not selectMapEvent then
	...
	selectMapEvent.Parent = remotesFolder
end
